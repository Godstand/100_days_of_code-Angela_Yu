...
start_button = Button(text="Start", bg="white", font=(FONT_NAME, 10, "bold"), highlightthickness=0, command=start_timer)
start_button.grid(column=0, row=2)

reset_button = Button(text="Reset", bg="white", font=(FONT_NAME, 10, "bold"), highlightthickness=0, command=reset_timer)
reset_button.grid(column=3, row=2)

check_marks = Label(fg=GREEN, bg=YELLOW, font=20, highlightthickness=0)
